...
**Deploy:** The workflow (`.github/workflows/deploy.yml`) deploys the **web/** folder to InfinityFree. Use secrets `FTP_SERVER` (usually `ftpupload.net`), `FTP_USERNAME`, and `FTP_PASSWORD` in GitHub Actions.
